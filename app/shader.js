...
export default function Shader({style,className,variant=0}){
 ...
 },[variant]);return <canvas ref={ref} className={className} style={{width:'100%',height:'100%',...style}} aria-hidden="true"/>;
}
