...
export default function Shader({style,className,variant=0,fps=60,maxDpr=2,tone='mono'}){
 ...
 },[variant,fps,maxDpr,tone]);return <canvas ref={ref} className={className} style={{width:'100%',height:'100%',...style}} aria-hidden="true"/>;
}
