  ...
  return <GlowIntroContext.Provider value={playGlowIntro}><GlowBackgroundContext.Provider value={light?'#f1f0ed':'#000000'}><div ref={root} className={'engineering-site '+(light?'engineering-light':'')}>
    ...
    <main id="portfolio-content">
      {page==='home'?<>
        ...
        {page==='about'&&<><Glow className="engineering-panel-glow"><div className="engineering-about engineering-enter"><p className="engineering-lead">{source.about}</p><div className="engineering-school-glass"><div className="engineering-education"><small>Education</small><h2>University of California,<br/>Berkeley</h2><p>Mechanical Engineering<br/>Intended minor in Structural Engineering</p></div></div></div></Glow><h2 className="engineering-subtitle">What I’m interested in.</h2><div className="engineering-chips">{source.interests.map(interest=><Glow className="engineering-chip-glow" key={interest}><span>{interest.replace('Strucural','Structural')}</span></Glow>)}</div></>}
